...
def extract_file_text(file: io.BytesIO, file_name: str, break_on_unprocessable: bool = False) -> str:
    ...
    # Plain text files
    TEXT_EXTENSIONS = {".txt", ".md", ".csv", ".json", ".xml", ".html", ".htm", ".yaml", ".yml", ".log", ".ini", ".cfg", ".toml", ".rst", ".tex"}
    ...
    # Images — no text extraction (expected behavior)
...
def xlsx_to_text(file, file_name: str = "") -> str:
    return ""

def pptx_to_text(file, file_name: str = "") -> str:
    return ""